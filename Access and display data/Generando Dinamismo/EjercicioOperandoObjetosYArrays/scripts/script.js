...
displayDatos = document.getElementById("datos");
displaymascota = document.querySelector(".mascota");

datos.innerHTML = `
    <p>Me llamo ${Persona.nombre} ${Persona.apellido}</p>
    <p>Tengo una ${Persona.vivienda.tipo} con ${Persona.vivienda.habitaciones} habitaciones</p>
    <p>Mi deporte favorito es: ${Persona.deporteFavorito}</p>
`

displaymascota.innerHTML = `
    <h1>${Persona.mascota.nombre}</h1>
    <p>Comidas favoritas: ${Persona.mascota.comidasFavoritas}</p>
    <p> ${Persona.mascota.edad} años</p>
`